...
<h1 class="text-4xl font-bold text-white md:text-6xl">About Us</h1>
<PageContainer>
    <SolyncLogo class="mb-24 w-110 fill-white" />
    <p class="mt-4 text-lg font-semibold md:max-w-170 md:text-2xl">
        <span class="text-4xl"><strong>Solync</strong></span> is a software collective driven by simple principles: putting users first, challenging
